...
| **Name** | String (max 31 chars) | Required | User recognizable name for the payment method. |
...
| **Type** | String | Optional | Defines the type of payment. Valid values include CREDIT_CARD or NON_CREDIT_CARD. |
...
QuickBooks Online comes with several pre-configured payment methods:
